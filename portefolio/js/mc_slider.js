    ...
    return this.each(function(){
            ...
            this.hoverSlide = function () {
                ...
                this.slider.mouseover(function(){
                    if (__this.flag === true && __this.clickFlag === true &&  __this.flagNavigation  === true ) {
                        __this.flag = false;
                    }
                });
        ...
        //accessibilité navigation clavier
            ...
            this.setArrowSlide = function() {                                 
                $("<div class='direction arrow next' tabindex ='0'><a href='javascript:void(0);'>+</a></div>").appendTo(this.wrapper);
                $('<div class="direction arrow previous" tabindex ="0"><a href="javascript:void(0);">+</a></div>').prependTo(this.wrapper);                     
            }
            ...
            this.stickySwipe = function() {
              ...
              if (__this.swipeFlag === true) {
                $(this).swipe(function( direction, offset ) {
                  ...
                  if (direction.x === "left" && __this.swipeFlag === false && absOffset > 200) {
                    __this.swipeFlag = true;
                    __this.slide( "right" );
                  }
                  if (direction.x === "right" && __this.swipeFlag === false && absOffset > 200) {
                    __this.swipeFlag = true;
                    __this.slide( "left");
                  }
                });
